...
dependencies {
    ...
    // 오라클 SDK
    implementation("com.oracle.oci.sdk:oci-java-sdk-bom:3.23.1") // 의존성+버전 관리
    implementation("com.oracle.database.jdbc/ojdbc10@19.20.0.0") // 오라클 연결+데이터 액세스
    implementation("com.oracle.oci.sdk:oci-java-sdk-common:3.23.1") // OCI SDK
